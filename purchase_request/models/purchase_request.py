...
class PurchaseRequest(models.Model):
    ...
    def action_view_purchase_order(self):
        """Method to action view purchase order."""
        action = self.env.ref(
    ...
    def action_view_stock_move(self):
        """Method to action view stock move."""
        action = self.env.ref(
    ...
    def action_view_purchase_request_line(self):
        """Method action view purchase request line."""
        action = self.env.ref(
    ...
    def button_draft(self):
        """Method to button draft."""
        self.mapped('line_ids').do_uncancel()
        return self.write({'state': 'draft'})

    def button_to_approve(self):
        """Method for button approve."""
    ...
    def button_approved(self):
        """Method for button approved."""
        self.assigned_to = self.env['res.users'].browse(self.env.uid)
        return self.write({'state': 'approved'})

    def button_rejected(self):
        """Method for button rejected."""
        self.mapped('line_ids').do_cancel()
        return self.write({'state': 'rejected'})

    def button_done(self):
        """Method to button done."""
        return self.write({'state': 'done'})

    def check_auto_reject(self):
        """When all lines are cancelled the purchase."""
    ...
    def to_approve_allowed_check(self):
        """Method to approve allowed check."""
        for rec in self:
