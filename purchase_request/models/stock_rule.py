...
class StockRule(models.Model):
    ...
    def _make_pr_get_domain(self, values):
        """Method is to be implemented by other modules that can provide."""
        """criteria to select the appropriate purchase request to be extended."""
